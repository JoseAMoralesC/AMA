...
@push('js')
    ...
    <script>
        function inputSize(){
            if($(window).width() < 575){
                $('#apellido2, #telefono, #cod_postal,#repetir_password').css('margin-left','auto');
                $('#altura, #peso').css('margin-left','auto');
                $('#apellido2, #telefono, #cod_postal,#altura,#peso,#repetir_password').css('margin-top','calc(0.375rem + 1px)');
            }else{
                $('#apellido2, #telefono, #cod_postal,#repetir_password').css('margin-left','0.8rem');
                $('#altura, #peso').css('margin-left','1.8rem');
                $('#apellido2, #telefono, #cod_postal,#altura, #peso,#repetir_password').css('margin-top','auto');
            }
        }
